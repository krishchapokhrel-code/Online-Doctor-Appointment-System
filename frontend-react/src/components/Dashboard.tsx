...
import { 
  Shield, LayoutDashboard, Calendar, Users, FileText, 
  Asterisk, Settings, LogOut, Search, Bell, MessageSquare,
  Heart, Moon, Scale, ChevronRight
} from 'lucide-react';
          ...
          <div className="flex items-center gap-5">
            ...
            <button className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
              ...
              <div className="text-left hidden sm:block">
                <div className="text-sm font-semibold text-text-main leading-tight">Ganesh Dahal</div>
                <div className="text-xs text-text-mut font-medium">#CS-9921</div>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 lg:p-8">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-text-main mb-1">Good morning, Alex.</h1>
              ...
              <button className="bg-primary hover:bg-primary-hover text-white px-5 py-2.5 rounded-btn font-medium transition-colors whitespace-nowrap self-start sm:self-auto text-sm shadow-sm">
                + Book Appointment
              </button>
            </div>
              ...
              <div className="w-full lg:w-[340px] flex flex-col gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-bg-base transition-colors border border-transparent hover:border-card-border">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-sm font-semibold text-text-main truncate">Dr. Sarah Jenkins</h3>
                    ...
                    <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-bg-base transition-colors border border-transparent hover:border-card-border">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-sm font-semibold text-text-main truncate">Dr. Michael Chen</h3>
                ...
                <div className="bg-[#e8f8f4] border border-[#a7dccf] rounded-card p-5 shadow-sm text-[#115e49]">
                  ...
                  <p className="text-sm opacity-90 leading-relaxed">
                    Don't forget to complete your pre-appointment screening form for Dr. Jenkins.
                  </p>
                </div>
