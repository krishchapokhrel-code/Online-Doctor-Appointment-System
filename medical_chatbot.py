...
# DATABASE(Not Decieded which one to use by PM and BA)
...
# FUNCTION to register in json file
...
- booking → guide user step by step
...
print("Medical Chatbot Started (ML + Gemini)\n")
